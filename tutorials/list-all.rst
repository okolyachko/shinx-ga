...
.. tabbed:: Web
   ...
   - `Building a voice assistant for web (JavaScript) <list/adding-voice-to-a-web-application.html>`__
     
     Learn how to to create a voice interface for a web app or a website from scratch and write simple voice commands.
	  
   - `Creating a voice-enabled food delivery app: complete tutorial <list/food-delivery-tutorial.html>`__
     
     Learn how to create a completely voice-enabled food delivery application.

   - `Using dynamic entities in the voice script <list/using-dynamic-entities.html>`__
...
.. tabbed:: iOS
   ...
   - `Highlighing items with voice <ios/highlighting-swift.html>`__

     Learn how to go through the list of items with voice and highlight the current item in the app UI.

   - `Triggering voice script actions without commands <ios/triggering-info-swift.html>`__

     Learn how to make Alan tell detailed information about an item selected in the app UI without giving a voice command.

   - `Playing a greeting in an iOS Swift app <ios/greeting-swift.html>`__

     Learn how to make Alan play a greeting to the user when the app is launched.
	 
.. tabbed:: Android

   - `Building a voice assistant for an Android Java or Kotlin app <android/integrating-java-kotlin.html>`__
   
     Learn how create a voice interface for an Android Java or Kotlin app from scratch and write simple voice commands.
	 
   - `Navigating between screens in an Android app (Kotlin) <android/navigating-kotlin.html>`__
   
     Learn how to send commands to an iOS Swift app, handle commands on the app side and navigate between screens with voice.

   - `Passing the app state to the voice script <android/sending-data.html>`__
   
     Learn how to pass the app state from an Android app to the voice script with visual state, access the data passed with visual state in the voice script and filter intents by the app state.
	 
   - `Highlighting items with voice (Kotlin) <android/highlighting-kotlin.html>`__
   
     Learn how to go through the list of items with voice and highlight the current item in the app UI.
	 
.. tabbed:: Flutter

   - `Building a voice assistant for a Flutter app <flutter/integrating-flutter.html>`__
   
     Learn how create a voice interface for a Flutter app from scratch and write simple voice commands.

   - `Navigating between views in a Flutter app <flutter/navigating-flutter.html>`__

     Learn how to send commands to a Flutter app, handle commands on the app side and navigate between views with voice.

   - `Passing the app state to the voice script <flutter/sending-data-flutter.html>`__
...
.. tabbed:: Ionic
   ...
   - `Building a voice assistant for an Ionic Angular app <ionic/integrating-angular.html>`_
   
     Learn how create a voice interface for an Ionic Angular app from scratch and write simple voice commands.
	 
   - `Navigating between tabs in an Ionic Angular app <ionic/navigating-angular.html>`__
   
     Learn how to send commands to an Ionic Angular app, handle commands on the app side and navigate between tabs with voice.
	 
   - `Passing the app state to the voice script (Ionic Angular) <ionic/sending-data-angular.html>`__
   ...
   - `Building a voice assistant for an Ionic React app <ionic/integrating-react.html>`_
   
     Learn how create a voice interface for an Ionic React app from scratch and write simple voice commands.
	 
   - `Navigating between tabs in an Ionic React app <ionic/navigating-react.html>`__
