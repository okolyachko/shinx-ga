...
-  Identify unhandled requests and find shortcuts to let users get
   faster with the voice
-  Optimize the voice assistant effectiveness

Voice analytics is presented in two views in Alan Studio:

-  `Projects dashboard <#working-with-the-projects-dashboard>`__
-  `Analytics view <#working-with-the-analytics-view>`__
...
-  `Interactions and Recognized <#interactions-and-recognized>`__
-  `Session and Mic Time <#session-and-mic-time>`__
-  `Users and Sessions <#users-and-sessions>`__
-  `Users by Location <#users-by-location>`__
...
This widget allows you to analyze how the conversation flows: where users start, continue and finish the dialog with the voice assistant. It helps you understand the users' behavior and design a successful voice experience.

The widget visualizes patterns as segments laid out around the circle with arrows going between them. To see the flow for a specific pattern, hover over the corresponding segment. Alan will display the previous and next patterns in the dialog.

You can also get the following information:

-  **Pattern frequency**: The segment length indicates the frequency of the pattern use: the more often the pattern was matched, the longer the segment is.

-  **Flow frequency**: The arrow width indicates the frequency of the flow use: the more often the pattern sequence was followed, the wider the arrow is.

To see the exact number of pattern matches or users following a specific sequence, hover over the segment or arrow and notice the number in the box in the top left corner of the widget.

.. image:: /_static/assets/img/studio/pattern-flow.png
