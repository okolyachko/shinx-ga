...
You can add predefined scripts to your project or create custom scripts for your application. For details, see `Voice scripts <scripts.html>`__.
...
.. warning::
	...
	When you delete a project, all scripts you have in the project are permanently deleted as well. You may want to save your scripts beforehand. For details, see `Exporting scripts <scripts.html#exporting-scripts>`__.
