...
- `Building a voice assistant for web (JavaScript) <adding-voice-to-a-web-application.html>`__
     
  Learn how to to create a voice interface for a web app or a website from scratch and write simple voice commands.
	  
- `Creating a voice-enabled food delivery app: complete tutorial <food-delivery-tutorial.html>`__
     
  Learn how to create a completely voice-enabled food delivery application.

- `Using dynamic entities in the voice script <using-dynamic-entities.html>`__
