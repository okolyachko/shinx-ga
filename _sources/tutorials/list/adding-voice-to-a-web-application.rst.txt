...
Web <../../client-api/web/web-api.html>`__. In this tutorial, we will voice enable a simple webpage. You will be able to click the Alan button on the page, give custom voice commands and get Alan's responses.
...
1. In the code editor, add the following    `intents </server-api/commands-and-responses.html#intent>`__. An intent is
...
2. Save the changes.
3. You can test your voice script in the `Debugging Chat </usage/guides/script-testing.html#debugging-chat>`__ area in the
