...
When users open the app, we want Alan to greet them and prompt what they can do with voice. To do this, we will use Alan's `onUserEvent() predefined callback <../../server-api/api/api-reference.html#onuserevent>`__.
