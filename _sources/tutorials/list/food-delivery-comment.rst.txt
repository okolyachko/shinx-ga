...
The user may leave a comment to the order, which can be any phrase. To capture an open-end phrase, we can use a `slot with a greedy RegEx <../../server-api/slots.html#getting-any-user-input>`__.
