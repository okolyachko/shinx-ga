...
In this tutorial, we will continue working with items in the table. We will add a function that will make Alan describe details of a selected item. To achieve this, we will use Alan's `project API <../../server-api/sending-data/project-api.html>`__. With the project API, you can define a method in the voice script, and then call this method in the app whenever needed.
...
When this method is called, Alan does the only thing — plays the following response:
...
Have a look at the next tutorial: `Playing a greeting in an iOS Swift app <greeting-swift.html>`__.
