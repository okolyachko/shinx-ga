...
- `Building a voice assistant for an Ionic Angular app <iintegrating-angular.html>`_
   
  Learn how create a voice interface for an Ionic Angular app from scratch and write simple voice commands.
	 
- `Navigating between tabs in an Ionic Angular app <navigating-angular.html>`__
   
  Learn how to send commands to an Ionic Angular app, handle commands on the app side and navigate between tabs with voice.
	 
- `Passing the app state to the voice script (Ionic Angular) <sending-data-angular.html>`__
...
- `Building a voice assistant for an Ionic React app <integrating-react.html>`_
   
  Learn how create a voice interface for an Ionic React app from scratch and write simple voice commands.
	 
- `Navigating between tabs in an Ionic React app <navigating-react.html>`__
