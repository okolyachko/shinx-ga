...
You can create a voice assistant or chatbot and embed it to your Vue app with Alan's `voice assistant SDK for Web <../../client-api/web/web-api.html>`__. In this tutorial, we will create a simple voice enabled Vue app. The app users will be able to click the Alan button and give custom voice commands, and Alan will reply to them.
...
-  Vue CLI. For details, see `Vue documentation <https://cli.vuejs.org/guide/installation.html>`__.
-  Node.js or yarn.
...
3. Start the app:
   ...
   .. image:: /_static/assets/img/web-frameworks/vue-starter-app.png
...
Let's add some `voice commands <../../server-api/commands-and-responses.html>`__ so that we can interact with our Vue app through voice. In Alan Studio, open the project and, in the code editor, add the following intents:
...
.. image:: /_static/assets/img/web-frameworks/vue-app-button.png
