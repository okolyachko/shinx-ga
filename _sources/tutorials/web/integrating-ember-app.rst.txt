...
You can create a voice assistant or chatbot and embed it to your Ember app with Alan's `voice assistant SDK for
Web <../../client-api/web/web-api.html>`__. In this tutorial, we will create a simple voice enabled Ember app. The app users will be able to click the Alan button and give custom voice commands, and Alan will reply to them.
...
To go through this tutorial, make sure Node.js and the Ember CLI are installed on your machine. For details, see `Ember documentation <https://guides.emberjs.com/v3.4.0/getting-started/quick-start/>`__.
...
3. Start the app:
   ...
   .. image:: /_static/assets/img/web-frameworks/ember-starter-app.png
...
Let's add some `voice commands <../../server-api/commands-and-responses.html>`__ so that we can interact with our Ember app through voice. In Alan Studio, open the project and, in the code editor, add the following intents:
...
.. image:: /_static/assets/img/web-frameworks/ember-app-button.png
