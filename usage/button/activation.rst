...
- `Use the wake word <customization.html#using-the-wake-word>`__. This method works for iOS and Android platforms and can only be used if the **Enable "Hey Alan" wakeword** option is enabled in Alan Studio. 
- Use the `activate() </client-api/methods/common-api.html#activate>`__ method for the Alan button to activate it programmatically.
...
- Use the `deactivate() </client-api/methods/common-api.html#deactivate>`__ method for the Alan button to deactivate it programmatically
