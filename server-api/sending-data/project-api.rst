...
The defined project API method must then be called in the client app with `callProjectApi() </client-api/methods/common-api.html#callprojectapimethodstring-dataobject-callbackfunction>`__. ``callProjectApi()`` takes the following arguments: 
