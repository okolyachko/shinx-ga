...
+--------------------------------------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``onButtonState``                    | function      | A callback for receiving the connection state of the Alan button. For details, see `onButtonState handler <../methods/state-handler.html>`__.                                                                                                                         |
+--------------------------------------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``onEventHandler``                   | function      | A callback Responsible for handling events received from Alan. For details, see `onEvent handler <../methods/event-handler.html>`__.                                                                                                                                  |
+--------------------------------------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
